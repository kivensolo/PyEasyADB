...
class DeviceA_Area(QWidget):
    ...
    def __init__(self):
        ...
        # 创建a1图像按钮
        self.btn_a1 = AppPushButton(self, self.slot_a1)
        ...
        # 创建a3图标
        self.btn_a3 = AppPushButton(self, self.slot_a3)
        self.btn_a3.setText("a3")
        self.hLayout.addWidget(self.btn_a3)

        # 尾端添加弹簧，以至于布局呈现靠左而不是居中
